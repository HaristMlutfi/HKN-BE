...
func InitGorm(dbCfg *config.DBConfig) (*gorm.DB, error) {
	...
	//	&models.CancellationOrder{},
	//	&models.ConfirmedCancellationOrder{},
	//)
	return db, nil
}
...
//
//	err := scatter(
//		len(db.dbs), func(idx int) (err error) {
